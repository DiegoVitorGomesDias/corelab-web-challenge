...
export const login = async (ctx) =>
{
    ...
    const [ _typeCodec, userToken ] = ctx.headers.authorization.split(" ");
...
export const deleteUser = async (ctx) =>
{
    ...
    try 
    {
        ...
        const dataNotes = await prisma.note.deleteMany({ where: { userId } });
        const dataUserDelete = await prisma.user.delete({ where: { id: userId } });
        
        return ctx.body = userId, dataNotes, dataUserDelete;        
    } 
